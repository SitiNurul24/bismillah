                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:12px;font-weight: 600;">Pengaturan</p>
                            ...
                            <td width="15%">
                                ...
                                $appointmentrow = $database->query("select  * from  janjitemu where janjitgl>='$today';");
                                $schedulerow = $database->query("select  * from  jadwal where jadwaltgl='$today';");
                                ...
                                <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        ...
                                        <div>
                                               ...
                                               Ubah detail akun anda dan ubah katasandi
                                                </div>
                                        </div>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                   Lihat Informasi pribadi dari akun kamu
                                                </div>
                                        </div>
                            ...
                            <td style="width: 25%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        ...
                                        <div>
                                                ...
                                                <div class="h3-dashboard"  style="font-size: 15px;">
                                                   Akan menghapus akun secara permanen
                                                </div>
                                        </div>
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            Kamu akan menghapus data akun ini<br>('.substr($nameget,0,40).').
                        ...
                        <a href="pengaturan.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;Tidak&nbsp;&nbsp;</font></button></a>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="pengaturan.php">&times;</a>
                        <div class="content">
                            Aplikasi Web Dokter Elektronik<br>
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        ID DOKTER : '.$id.' (Dibuat otomatis)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="Tele" class="input-text" placeholder="Nomer telpon Number" value="'.$tele.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Pilih Spesialisasi: ( Spesialisasi sekarang '.$spcil_name.')</label>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="password" class="input-text" placeholder="Buat kata sandi baru " required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="cpassword" class="input-text" placeholder="Konfirmasi kata sandi baru" required><br>
                                        </td>
                                    </tr>
