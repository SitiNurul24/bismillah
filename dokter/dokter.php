                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">jk@gmail.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="cari" class="input-text header-searchbar" placeholder="cari nama dokter dan email" list="dokter">&nbsp;&nbsp;
...
?>
                ...
                <tr >
                    <td colspan="2" style="padding-top:30px;">
                        <p class="heading-main12" style="margin-left: 45px;font-size:20px;color:rgb(49, 49, 49)">Tambahkan Dokter </p>
                    <td colspan="2">
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from dokter where dokemail='$keyword' or doknama='$keyword' or doknama like '$keyword%' or doknama like '%$keyword' or doknama like '%$keyword%'";
                    }else{
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                       ...
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$dokid.'&name='.$nama.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Remove</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
    ...
    if($_GET){
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div class="content">
                            You want to delete this record<br>('.substr($namaget,0,40).').
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nic" class="input-text" placeholder="Nomer NIK" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="tel" name="Tele" class="input-text" placeholder="Nomer Telephone" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="spec" class="form-label">Pilih Spesialisasi: </label>
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="cpassword" class="input-text" placeholder="Konfirmasi Kata Sandai" required><br>
                                </td>
                            </tr>
        ...
        ';
            ...
            $spcil_res= $database->query("select sname from spesialis where id='$spe'");
            $spcil_array= $spcil_res->fetch_assoc();
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="name" class="input-text" placeholder="Nama Dokter" value="'.$nama.'" required><br>
                                        </td>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="text" name="nik" class="input-text" placeholder="Nomer NIC" value="'.$nik.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="tel" name="Tele" class="input-text" placeholder="Nomer Telephone" value="'.$tele.'" required><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <label for="spec" class="form-label">Choose specialties: (Current'.$spcil_nama.')</label>
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="password" name="Kata sandi" class="input-text" placeholder="Tentukan Kata Sandi" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
                                            <label for="cpassword" class="form-label">Konfirmasi Kata Sandi: </label>
