            ...
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-patient menu-active menu-icon-patient-active">
                        <a href="pasien.php" class="non-style-link-menu  non-style-link-menu-active"><div><p class="menu-text">Pasien</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
        ...
        <?php       
                    ...
                    if($_POST){
                        ...
                        if(isset($_POST["search"])){
                            ...
                            $sqlmain= "select * from pasien where pemail='$keyword' or pnama='$keyword' or pnama like '$keyword%' or pnama like '%$keyword' or pnama like '%$keyword%' ";
                            $selecttype="my";
                        }
                        
                        if(isset($_POST["filter"])){
                            if($_POST["showonly"]=='all'){
                                $sqlmain= "select * from pasien";
                                $selecttype="All";
                                $current="All pasien";
                            }else{
                                $sqlmain= "select * from janjitemu inner join pasien on pasien.pid=janjitemu.pid inner join jadwal on jadwal.jadwalid=janji.jadwalid where jadwal.dokid=$userid;";
                                $selecttype="My";
                                $current="My pasien Only";
                            }
                        }
                    }else{
                        $sqlmain= "select * from janjitemu inner join pasien on pasien.pid=janjitemu.pid inner join jadwal on jadwal.jadwalid=janjitemu.jadwalid where jadwal.dokid=$userid;";
                        $selecttype="My";
                    }
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="search" name="search12" class="input-text header-searchbar" placeholder="Cari nama pasien atau email pasien" list="patient">&nbsp;&nbsp;
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="pasien.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all pasien &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Telephoe" class="form-label">Telephone: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="pasien.php"><input type="button" value="OK" class="login-btn btn-primary-soft btn" ></a>
