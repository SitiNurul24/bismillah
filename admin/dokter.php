    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor menu-active menu-icon-dokter-active">
                        <a href="dokter.php" class="non-style-link-menu non-style-link-menu-active"><div><p class="menu-text">Dokter</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-appoinment">
                        <a href="jani-temu.php" class="non-style-link-menu"><div><p class="menu-text">Janji Temu</p></a></div>
                    </td>
                </tr>
                <tr class="menu-row" >
                ...
                <tr >
                    ...
                    <td>
                        ...
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="cari" name="cari" class="input-text header-searchbar" placeholder="Cari Nama atau Email Dokter" list="dokters">&nbsp;&nbsp;
                            
                            <?php
                                echo '<datalist id="dokters">';
...
?>
                ...
                <?php
                    if($_POST){
                        ...
                        $sqlmain= "select * from dokter where docemail='$keyword' or docname='$keyword' or docname like '$keyword%' or docname like '%$keyword' or docname like '%$keyword%'";
                    }else{
                        $sqlmain= "select * from dokter order by dokid desc";
                        ...
                        <tbody>
                            ...
                            <?php
                                ...
                                if($result->num_rows==0){
                                    ...
                                    <a class="non-style-link" href="dokter.php"><button  class="login-btn btn-primary-soft btn"  style="display: flex;justify-content: center;align-items: center;margin-left:20px;">&nbsp; Show all dokters &nbsp;</font></button>
                                    </a>
                                    </center>
                                    <br><br><br><br>
                                    </td>
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <a href="?action=edit&id='.$dokid.'&error=0" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-edit"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Edit</font></button></a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="?action=view&id='.$dokid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Lihat</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$dokid.'&name='.$name.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Hapus</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
        ...
        if($action=='drop'){
            ...
            ';
                ...
                $errorlist= array(
                    ...
                    '2'=>'<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Kesalahan Konformasi Kata Sandi! Sesuaikan Kembali Kata Sandi</label>',
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td>
                                    <p style="padding: 0;margin: 0;text-align: left;font-size: 25px;font-weight: 500;">Add New dokter.</p><br><br>
                                </td>
                            </tr>
                            
                            <tr>
                                <form action="tambah-baru.php" method="POST" class="add-new-form">
                                <td class="label-td" colspan="2">
                                    <label for="name" class="form-label">Nama: </label>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="nik" class="input-text" placeholder="Nomor NIK" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="tel" name="Tele" class="input-text" placeholder="Nomor Telepon" required><br>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <select name="spec" id="" class="box" >';
                                        ...
                                        $list11 = $database->query("select  * from  spesialis order by snama asc;");
                        ...
                        echo     '       </select><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="password" name="password" class="input-text" placeholder="Menemukan Kata Sandi" required><br>
                                </td>
                            </tr><tr>
                                <td class="label-td" colspan="2">
            ...
            ';
                ...
                echo '
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                            <br><br><br><br>
                                <h2>Menambah Data Baru Sukses!</h2>
                                <a class="close" href="dokter.php">&times;</a>
                                <div class="content">
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        dokter ID : '.$id.' (Auto Generated)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <form action="edit-dok.php" method="POST" class="add-new-form">
                                            <label for="Email" class="form-label">Email: </label>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <select name="spec" id="" class="box">';
                                                ...
                                                $list11 = $database->query("select  * from  spesialis;");
                                ...
                                echo     '       </select><br><br>
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="katasandi" name="katasandi" class="input-text" placeholder="Menemukan Kata Sandi" required><br>
                                        </td>
                                    </tr><tr>
                                        <td class="label-td" colspan="2">
                                    ...
                                    <tr>
                                        <td class="label-td" colspan="2">
                                            <input type="konfirmasikatasandi" name="konfirmasikatasandi" class="input-text" placeholder="Konfirmasi Kata Sandi" required><br>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            <input type="reset" value="Mengatur Ulang" class="login-btn btn-primary-soft btn" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
