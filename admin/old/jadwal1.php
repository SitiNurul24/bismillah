    ...
    <div class="container">
        <div class="menu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row" >
                    <td class="menu-btn menu-icon-jadwal menu-active menu-icon-schedule-active">
            ...
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                <tr >
                    ...
                    <td width="15%">
                        ...
                        $list110 = $database->query("select  * from  jadwal;");
                ...
                <?php
                    if($_POST){
                        ...
                        //echo $sqlpt2;
                        //echo $sqlpt1;
                        $sqlmain= "select jadwal.jadwalid,jadwal.title,dokter.doknama,jadwal.jadwaltgl,jadwal.jadwalwaktu,jadwal.nop from jadwal inner join dokter on jadwal.dokid=dokter.dokid ";
                        ...
                        $sqlmain= "select jadwal.jadwalid,jadwal.judul,dokter.doknama,jadwal.jadwaltgl,jadwal.jadwalwaktu,jadwal.nop from jadwal inner join dokter on jadwal.dokid=dokter.dokid  order by jadwal.jadwaltgl desc";
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr>
                                        ...
                                        <td style="text-align:center;">
                                            '.substr($jadwalwaktu,0,10).' '.substr($jadwalwaktu,0,5).'
                                        </td>
                                        <td style="text-align:center;">
                                            '.$nop.'
                                        </td>
                                        ...
                                        <a href="?action=view&id='.$jadwalid.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-view"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">View</font></button></a>
                                       &nbsp;&nbsp;&nbsp;
                                       <a href="?action=drop&id='.$jadwalid.'&name='.$judul.'" class="non-style-link"><button  class="btn-primary-soft btn button-icon btn-delete"  style="padding-left: 40px;padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Remove</font></button></a>
                                        </div>
                                        </td>
                                    </tr>';
        ...
        if($action=='tambah-sesi'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <input type="text" name="judul" class="input-text" placeholder="Nama Sesi ini" required><br>
                                </td>
                            </tr>
                            <tr>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a class="close" href="jadwal.php">&times;</a>
                        <div class="content">
                        '.substr($titleget,0,40).' was jadwald.<br><br>
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <div style="display: flex;justify-content: center;">
                        <a href="hapus-sesi.php?id='.$id.'" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Yes&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
                        <a href="jadwal.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;No&nbsp;&nbsp;</font></button></a>
            ...
            $sqlmain= "select jadwal.jadwalid,jadwal.judul,dokter.doknama,jadwal.jadwaltgl,jadwal.jadwalwaktu,jadwal.nop from jadwal inner join dokter on jadwal.dokid=dokter.dokid  where  jadwal.jadwalid=$id";
            $result= $database->query($sqlmain);
            $row=$result->fetch_assoc();
            $doknama=$row["doknama"];
            $jadwalid=$row["jadwalid"];
            $judul=$row["judul"];
            $judultgl=$row["judultgl"];
            $judulwaktu=$row["judulwaktu"];
            
           
            $nop=$row['nop'];


            $sqlmain12= "select * from janji-temu inner join pasien on pasien.pid=janji-temu.pid inner join jadwal on jadwal.jadwalid=janji-temu.jadwalid where jadwal.jadwalid=$id;";
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="Email" class="form-label">Dokter pada sesi ini: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
