                        ...
                        <tr >
                            ...
                            <td colspan="2" class="nav-bar" >
                                ...
                                <form action="dokter.php" method="post" class="header-search">
                                    ...
                                    <input type="search" name="search" class="input-text header-searchbar" placeholder="Search dokter name or Email" list="dokters">&nbsp;&nbsp;
                                    
                                    <?php
                                        echo '<datalist id="dokters">';
                                        $list11 = $database->query("select  doknama,docemail from  dokter;");
                                ...
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex">
                                        <div>
                                                ...
                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/dokters-hover.svg');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex;">
                                        <div>
                                                ...
                                                <div class="btn-icon-back dashboard-icons" style="background-image: url('../img/icons/pasiens-hover.svg');"></div>
                                    </div>
                                </td>
                                <td style="width: 25%;">
                                    <div  class="dashboard-items"  style="padding:20px;margin:auto;width:95%;display: flex; ">
                        ...
                        <table width="100%" border="0" class="dashbord-tables">
                            <tr>
                                <td>
                                    ...
                                    Upcoming janjitemus until Next <?php  
                                ...
                                <td>
                                    ...
                                    Sesi Mendatang hingga Berikutnya <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
                                    </p>
                                ...
                                <td width="50%">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            $sqlmain= "select janjitemu.ajanjiid,jadwal.jadwalid,jadwal.title,dokter.doknama,pasien.pnama,jadwal.jadwaltgl,jadwal.jadwalwaktu,janjitemu.janjinom,janjitemu.janjitgl from jadwal inner join janjitemu on jadwal.jadwalid=janjitemu.jadwal
                                            id inner join pasien on pasien.pid=janjitemu.pid inner join dokter on jadwal.dokid=dokter.dokid  where jadwal.jadwaltgl>='$today'  and jadwal.jadwaltgl<='$nextweek' order by jadwal.jadwaltgl desc";
                                ...
                                <td width="50%" style="padding: 0;">
                                    <center>
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                            $nextweek=date("Y-m-d",strtotime("+1 week"));
                                            $sqlmain= "select jadwal.jadwalid,jadwal.title,dokter.doknama,jadwal.jadwaltgl,jadwal.jadwalwaktu,jadwal.nop from jadwal inner join dokter on jadwal.dokid=dokter.dokid  where jadwal.jadwaltgl>='$today' and jadwal.jadwaltgl<='$nextweek' order by jadwal.jadwaltgl desc"; 
                                                $result= $database->query($sqlmain);
                            ...
                            <tr>
                                <td>
                                    <center>
                                        <a href="janjitemu.php" class="non-style-link"><button class="btn-primary btn" style="width:85%">Tampilkan Semua Janji Temu</button></a>
                                    </center>
                                </td>
                                <td>
                                    <center>
